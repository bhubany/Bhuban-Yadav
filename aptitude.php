...
$query_question="SELECT * FROM aptitude";
...
$limit=$number_of_rows-5;
 ...
 ?>
 	...
 	<title>Questions and Discussion-Aptitude-cs</title>
<link rel="stylesheet" type="text/css" href="assests/css/discussion_questions_style.css">

 <div>

 	 <div class="subject_name">APTITUDE</div>


 	<?php
	for ($i=$number_of_rows; $i >$limit ; $i--) { 
		$question="SELECT * FROM aptitude WHERE id=$i LIMIT 1";
 	...
 	<div>
 	<br>
 <div id="aptitude" class="subject_questions">
...
<div  style="text-align: right;">
	...
	<form action="discussion_answers.php" method="post">
		<input type="hidden" name="subject" value="a">
...
<div class="view_all">
	<h3><a href="aptitude_all.php">VIEW ALL QUESTIONS OF APTITUDE</a></h3>
</div>