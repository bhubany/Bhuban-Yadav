...
<?php 
	...
	if (clean_values($con,isset($_GET['pageno']))) {
  	...
  	$total_pages_sql = "SELECT * FROM user_exam_details WHERE user_name='$username'";
	...
	$qry_test_details=@"SELECT * FROM user_exam_details WHERE user_name='$username' ORDER BY id DESC LIMIT $starting_from,$no_of_records_per_page";
	            ...
	            <tr align="center">
	              ...
	              <td>
	                <form action="" method="post">
      					<input type="hidden" name="check_rank_id" value="<?php echo($test_details_rows['id']); ?>">
      					<input type="hidden" name="check_rank_field_name" value="<?php echo($test_details_rows['field_name']); ?>">
      					<input type="hidden" name="check_rank_set_no" value="<?php echo($test_details_rows['set_no']); ?>">
      					<button type="submit" class="btn btn-success" name="checks_rank">Check rank</button>
      				</form>
	              </td>
	            </tr>
	            <?php $serial_number++; }  ?>
