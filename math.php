...
$query_question="SELECT * FROM math";
...
$limit=$number_of_rows-5;
 ...
 ?>
 	...
 	<title>Questions and Discussion-Math-cs</title>
 
 <div>
<link rel="stylesheet" type="text/css" href="assests/css/discussion_questions_style.css">

 <div class="subject_name">MATH</div>


 	<?php
	for ($i=$number_of_rows; $i >$limit ; $i--) { 
		$question="SELECT * FROM math WHERE id=$i LIMIT 1";
 	...
 	<div>
 	<br>
 <div id="math" class="subject_questions">
...
<div  style="text-align: right;">
 ...
 <?php } ?>
  ...
  <div class="view_all">
	<h3><a href="aptitude_all.php">VIEW ALL QUESTIONS OF MATH</a></h3>
</div>