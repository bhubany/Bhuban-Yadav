...
$query_question="SELECT * FROM english";
...
$limit=$number_of_rows-5;
 ...
 ?>
 	...
 	<title>Questions and Discussion-English-cs</title>
...
<div>
	...
	for ($i=$number_of_rows; $i >$limit ; $i--) { 
		$question="SELECT * FROM english WHERE id=$i LIMIT 1";
 	...
 	<div>
 	<br>
 <div id="english" class="subject_questions">
...
<div  style="text-align: right;">
	...
	<form action="discussion_answers.php" method="post">
		<input type="hidden" name="subject" value="e">
 ...
 <div class="view_all">
	<h3><a href="aptitude_all.php">VIEW ALL QUESTIONS OF ENGLISH</a></h3>
</div>